...
function adjustGapura3D() {
    ...
    // lebar atap menyesuaikan jalan
    const atap = gapura.querySelector('.atap');
    atap.style.width = Math.min(400, maxW / 2) + 'px';

    // scroll otomatis ke tengah jalan
...
window.addEventListener('resize', () => {
    ...
    window._adjustTimeout = setTimeout(adjustGapura3D, 120);
});

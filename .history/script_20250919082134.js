...
// Tambahkan Gapura di antara lapak 57 (kiri) dan 216 (kanan)
const roadLayout = document.querySelector(".road-layout");
const gapura = document.createElement("div");
gapura.className = "gapura";
gapura.textContent = "🌸 GAPURA SELAMAT DATANG 🌸";

// Sisipkan gapura setelah elemen .road
roadLayout.insertAdjacentElement("afterend", gapura);

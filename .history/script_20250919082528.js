...
// Pilih container jalan
const road = document.getElementById("road");

// Buat elemen gapura
const gapura = document.createElement("div");
gapura.className = "gapura";
gapura.textContent = "🌸 GAPURA SELAMAT DATANG 🌸";

// Sisipkan gapura di dalam scroll-container
document.querySelector(".scroll-container").appendChild(gapura);

// Posisi gapura bisa diatur sesuai lapak tertentu
// Misal lapak 57 (kiri) dan 216 (kanan) -> hitung posisi tengah
const totalLapak = 216;
const lapak57Pos = 57 / totalLapak * 100;
const lapak216Pos = 216 / totalLapak * 100;
const gapuraPos = (lapak57Pos + lapak216Pos) / 2;

gapura.style.left = `${gapuraPos}%`;

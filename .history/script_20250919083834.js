...
// ===== POSISI GAPURA PRESISI =====
function adjustGapuraPresisi() {
    ...
    // Posisi vertikal: tengah antara 57 & 58
    const rect57 = lapakBawah57.getBoundingClientRect();
    const rect58 = lapakBawah58.getBoundingClientRect();
    const scrollRect = scrollContainer.getBoundingClientRect();
    const topGapura = (rect57.top + rect58.top + rect57.height) / 2 - scrollRect.top;
    gapura.style.position = 'absolute';
    gapura.style.top = `${topGapura}px`;

    // Posisi horizontal: tengah antara lapak 145 & 146
    ...
    // Lebar atap menyesuaikan jarak antar lapak atas
    ...
    // Scroll otomatis agar gapura terlihat
...
window.addEventListener('resize', () => {
    ...
    window._adjustTimeout = setTimeout(adjustGapuraPresisi, 120);
});

...
// Nomor kecil (1,2,3...) ditempatkan di sisi kanan (bawah jalan)
leftNumbers.forEach(n => rightSide.appendChild(makeLapak(n)));

// Nomor besar (200an...) ditempatkan di sisi kiri (atas jalan)
rightNumbers.slice().reverse().forEach(n => leftSide.appendChild(makeLapak(n)));

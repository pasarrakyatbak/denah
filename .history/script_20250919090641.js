...
function placeSungaiBelowLapak(parent, targetNum, lebarLapak = 4) {
    ...
    const lapakWidth = rect.width + 15; // ukuran lapak + gap antar lapak
    sungai.style.left = (rect.left - containerRect.left) + "px";
    sungai.style.top = (rect.bottom - containerRect.top + 8) + "px";
    sungai.style.width = (lapakWidth * lebarLapak) + "px"; // lebar sungai

    parent.style.position = "relative";
    parent.appendChild(sungai);
}

// contoh: sungai sepanjang 4 lapak mulai dari 62
placeSungaiBelowLapak(leftSide, 62, 4);

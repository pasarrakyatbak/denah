...
lapaks.forEach(lapak => {
    ...
    leftOutline.className = 'lapak-outline left-outline';
    lapak.appendChild(leftOutline);

    const rightOutline = document.createElement('div');
    rightOutline.className = 'lapak-outline right-outline';
    lapak.appendChild(rightOutline);
});